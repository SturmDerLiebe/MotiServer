...
export class UserWeeklyTargetController {
    constructor(
        private readonly userWeeklyTargetService: UserWeeklyTargetService,
    ) {}
    ...
    update(
        @Param('id') id: string,
        @Body() updateUserWeeklyTargetDto: UpdateUserWeeklyTargetDto,
    ) {
        return this.userWeeklyTargetService.update(
            +id,
            updateUserWeeklyTargetDto,
        );
    }
