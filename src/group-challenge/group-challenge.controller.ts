...
export class GroupChallengeController {
  constructor(private readonly groupChallengeService: GroupChallengeService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateGroupChallengeDto: UpdateGroupChallengeDto) {
